...
insert into public.category_hierarchy (ancestor_id,descendant_id,depth) values
('10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001',0),
('10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000002',0),
('10000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000003',0),
('10000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000011',1),
('10000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000012',1),
('10000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000013',1)
...
('20000000-0000-4000-8000-000000000001','modern','مدرن','Modern','خطوط تمیز، فرم‌های ساده و کارایی','فرم‌های ساده و پلان باز','سبک مدرن بر عملکرد، خطوط روشن و حذف تزئینات غیرضروری تکیه دارد.','https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=1200&h=800','نشیمن مدرن', '["نشیمن","فضای کار"]'::jsonb,true),
...
('40000000-0000-4000-8000-000000000003','30000000-0000-4000-8000-000000000003','چراغ رومیزی آوا','table-lamp-ava','چراغ رومیزی با نور گرم و بدنه فلزی','نور گرم برای فضای دنج',4200000,null,'IRR','لوامینا','LL-AVA-1','فلز','طلایی','active','["modern","minimal"]'::jsonb,'["نور","رومیزی"]'::jsonb,49,81,305,now())
...
insert into public.inspirations (id,slug,title,image,style_slug,room,tags,description,product_ids,status,published_at) values
...
insert into public.credit_packages (id,slug,name,credits,price,currency,is_active,sort_order) values
('70000000-0000-4000-8000-000000000001','starter','بسته شروع',20,190000,'IRR',true,1),
('70000000-0000-4000-8000-000000000002','creator','بسته خلاق',60,490000,'IRR',true,2),
('70000000-0000-4000-8000-000000000003','studio','بسته استودیو',150,990000,'IRR',true,3)
on conflict (id) do update set credits=excluded.credits,price=excluded.price,is_active=true;
