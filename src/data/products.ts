...
export const products: Product[] = [
  {
    ...
    specs: [{ label: "نوع", value: "۳ نفره" }, { label: "پایه", value: "چوب راش" }, { label: "ضمانت", value: "۲۴ ماه" }],
  ...
  },
  {
    ...
    images: [IMG.living5],
    colors: [COLORS.white, COLORS.gold], materials: ["فلز", "شیشه"],
  ...
  },
  {
    ...
    specs: [{ label: "بافت", value: "شبیه دست‌بافت" }],
  ...
  },
  {
    ...
    description: "تخت نوردیک با پایه‌های چوبی کم‌رنگ و هدبورد ساده، آرامش یک اتاق خواب اسکاندیناوی.",
  ...
  },
  {
    ...
    description: "مبل ال با طراحی ماژولار و نشیمن گسترده، بهترین انتخاب برای پذیرایی‌های بزرگ و مناسب خانواده‌ها.",
  ...
  },
  {
    ...
    description: "پوف مخملی سبک برای نشستن یا به‌عنوان میز عربیه، یک لمس رنگین و راحت به فضا.",
