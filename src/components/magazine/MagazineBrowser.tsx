"use client";
// ============================================================
// MagazineBrowser — client island of /magazine (Task 33).
//
// The server page (`src/app/magazine/page.tsx`) renders the
// shell + CollectionPage JSON-LD; this island owns the ONLY
// interactive piece: the category filter chips (client-side
// state, zero navigation). Articles arrive as serialisable
// props — the data module itself never enters the client bundle.
// ============================================================
...
export function MagazineBrowser({ articles }: { articles: Article[] }) {
