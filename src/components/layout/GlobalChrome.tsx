  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden text-sm font-medium sm:inline">دستیار AI</span>
      </button>

      {/* Toasts */}
      <div className="fixed bottom-24 right-4 z-[120] flex flex-col gap-2 lg:bottom-6 lg:right-6">
        {toasts.map((t) => {
      ...
      {/* Compare bar */}
      {cmpCount > 0 && (
        <div className="fixed inset-x-0 bottom-16 z-40 mx-auto flex max-w-2xl items-center justify-between gap-3 rounded-2xl border border-clay/40 bg-ink px-4 py-3 text-cream shadow-[var(--shadow-lift)] sm:bottom-6 lg:mx-6 lg:right-6 lg:left-auto lg:w-auto lg:translate-x-0" style={{ margin: "0 1rem" }}>
