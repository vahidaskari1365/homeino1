...
export const metadata: Metadata = {
  ...
  description:
    "عکس فضای خودت را بارگذاری کن، سبک را انتخاب کن و نتیجه‌ی چیدمان جدید را قبل از خرید ببین. هومینو استودیو: محصولات واقعی را در عکس خانه‌ات ببین و جای آن‌ها را عوض کن.",
  openGraph: {
