            ...
            <tbody>
              {products.slice(0, 10).map((p) => (
                <tr key={p.id} className="border-b border-clay/30 hover:bg-ivory-2/50">
                  <td className="p-3"><div className="flex items-center gap-2"><SmartImage src={p.images[0]} alt="" className="h-9 w-9 shrink-0 rounded-lg" /><span className="line-clamp-1 font-medium text-ink">{p.name}</span></div></td>
